  ...
  <div class="container">
    <div class="row">
      <div class="column" style="margin-top: 10%">
        ...
        <!-- Your Image Here -->
        <img src="images/avatar.jpg" srcset="images/avatar@2x.png 2x" alt="LittleLink Logo" style="border-radius: 50%; width: 100px;">

        <!-- Title -->
        <h1>Cătălin Pleșu</h1>

        <!-- Short Bio -->
        <b>IT Student | Linux User | Anime Enjoyer</b>
        <br>
        <br>
        <br>
        <!--
        ...
        <!-- Github -->
        <a class="button button-github" href="https://github.com/CatalinPlesu" target="_blank" rel="noopener"><img class="icon"
            src="images/icons/github.svg" alt="GitHub Logo">GitHub</a>
        <br>

        <!-- Gitlab -->
        <a class="button button-gitlab" href="https://gitlab.com/catalinplesu" target="_blank" rel="noopener"><img class="icon"
            src="images/icons/gitlab.svg" alt="GitLab Logo">GitLab</a>
        <br>

        <!-- Telegram -->
        <a class="button button-telegram" href="https://t.me/catalinplesu" target="_blank" rel="noopener"><img class="icon"
        ...
        <!-- Reddit -->
        <a class="button button-reddit" href="https://www.reddit.com/user/_katarin" target="_blank" rel="noopener"><img class="icon"
            src="images/icons/reddit.svg" alt="Reddit Logo">Reddit</a>
        <br>

        <!-- Twitter -->
        <a class="button button-twit" href="https://twitter.com/catalinplesu" target="_blank" rel="noopener"><img class="icon"
        ...
        <!-- YouTube -->
        <a class="button button-yt" href="https://www.youtube.com/channel/UC752pTuCebS37pCYwYPirow" target="_blank" rel="noopener"><img class="icon"
            src="images/icons/youtube.svg" alt="YouTube Logo">YouTube</a>
        <br>

        <!-- LinkedIn -->
        <a class="button button-linked" href="https://www.linkedin.com/in/c%C4%83t%C4%83lin-ple%C8%99u-042872209/" target="_blank" rel="noopener"><img class="icon"
